...
- ADRs touched: none implemented as new — the commit *implements* ADRs 002 (Neon), 003 (Postgres as source of truth), 010, 013, 014, 015, 017, 018, 019, 020, 022, 024, 025, 026, 027, 028, 031, 032 (via `SiteTheme` inline mirror), 034, 036, 041. Per-table cross-references are inline in each schema file's top-of-file comment.
